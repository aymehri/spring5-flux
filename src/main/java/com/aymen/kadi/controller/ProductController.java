package com.aymen.kadi.controller;

import com.aymen.kadi.model.Product;
import com.aymen.kadi.model.ProductEvent;
...
public class ProductController {
    ...
    @GetMapping("{id}")
    public Mono<ResponseEntity<Product>> getAllProduct(@PathVariable String id) {
    ...
    public Mono<ResponseEntity<Void>> deleteProduct(@PathVariable(value = "id") String id) {
        return repository.findById(id)
                .flatMap(
                        existingProduct -> repository.delete(existingProduct)
